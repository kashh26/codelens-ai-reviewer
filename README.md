...
**Live app:** [codelens-ai-reviewer.streamlit.app](https://codelens-ai-reviewer-irmn6kepq8gn2wp3727bom.streamlit.app)
...
- Structured AI code review — bugs, security, style, performance, each with severity and fix suggestions
...
- Voice input/output — speak your questions, hear the answers, using the browser's free Web Speech API
...
- Managing conversation context and memory across follow-up turns
